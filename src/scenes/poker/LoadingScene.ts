...
class LoadingScene extends Phaser.Scene {
  ...
  preload() {
    ...
    this.load.audio('sound_draw', '/game/poker/sound/public_game_sound_draw.mp3');
    this.load.audio('sound_card_flip', '/game/poker/sound/public_game_sound_card_flip.mp3');
    this.load.audio('sound_card_deal', '/game/poker/sound/public_game_sound_card_deal.mp3');
    this.load.audio('sound_click', '/game/poker/sound/public_game_sound_click.mp3');
    // table
    this.load.image('table', '/game/common/images/backImage/betTable.jpg');
    // back
    this.load.image('backCard', '/game/common/images/cards/back_card.png');
